  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <head>
        ...
        <link rel="stylesheet" href="${contextPath}/css/join-pf.css">
          ...
          <section class="join_section">
            <form class="join_form" action="${contextPath}/member/join.do" method="post">
              <div class="join_txt_area input_id_txt">
                <span class="inner_warning">아이디</span>
                <input type="text" name="id" autocomplete="off" autocorrect="off" autocapitalize="none" title="아이디입력"
              ...
              <div class="join_txt_area">
                <span class="inner_warning btn_addr_txt">교수로 가입하기</span>
