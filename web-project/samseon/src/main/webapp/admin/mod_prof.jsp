                    ...
                    <div id="contents_area">
                        <section class="form_section">
                            <div class="contents_wrapper">
                                <h3>교수 정보 수정</h3>
                                <form action="${contextPath }/manage/mod_prof.do" method="post" id="privacy_modForm"
                                        ...
                                        <tbody>
                                            ...
                                            <c:choose>
                                                <c:when test="${prof_info.check_sign eq -1 }">
                                                    <tr>
                                                        <th>학번(아이디)</th>
                                                        <td><input name="pf_id" class="tbl_input" type="number"
                                                                value="${prof_info.pf_id}" readonly></td>
                                                    </tr>
                                                    <tr>
                                                        <th>단과 대학</th>
                                                        <td><input name="dan" class="tbl_input" type="text"
                                                                value="${prof_info.dan}"></td>
                                                    </tr>
                                                    <tr>
                                                        <th>학과 명</th>
                                                ...
                                                <c:when test="${prof_info.check_sign eq 0 }">
                                                    ...
                                                    <tr>
                                                        <th>이름</th>
                                                        <td><input name="pf_name" class="tbl_input" type="text"
                                                                value="${prof_info.pf_name}"></td>
                                                    </tr>
                                                    <tr>
                                                        <th>전화번호</th>
                                                        <td><input id="phone" name="pf_ph" class="tbl_input" type="text"
                                                                value="${prof_info.pf_ph}"></td>
                                                    </tr>
                                                    <tr>
                                                        <th>이메일</th>
                                                        <td><input id="email" name="pf_email" class="tbl_input"
                                                                type="text" value="${prof_info.pf_email}"></td>
                                                    </tr>
                                                    <tr>
                                                        <th>단과 대학</th>
                                                        <td><input name="dan" class="tbl_input" type="text"
