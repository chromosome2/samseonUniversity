    ...
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <body>
              ...
              <div class="wrap_login">
                ...
                <form class="login_form" name="frmLogin" method="post" action="${contextPath}/member/login.do">
                  ...
                  aria-hidden="true"></i></a> -->
                    <a class="dummy_txt">|&nbsp;&nbsp;</a><a class="txt2 show-modal">회원가입<i
                        class="fa fa_long_arrow_right " aria-hidden="true"></i></a>
                  </div>
        ...
        <div class="modal hidden">
          ...
          <div class="btns_join">
            <button class="join_btn"><a href="${contextPath}/join.jsp">학생 회원가입</a></button>
            <button class="join_btn join_btn_pf"><a href="${contextPath}/join-pf.jsp">교수 회원가입</a></button>
          </div>
        </div>
